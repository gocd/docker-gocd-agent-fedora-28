...
# download the zip file
  curl --fail --location --silent --show-error "https://download.gocd.org/experimental/binaries/18.10.0-7534/generic/go-server-18.10.0-7534.zip" > /tmp/go-agent.zip && \
